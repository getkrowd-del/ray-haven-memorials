...
// Initialize Animations
  ...
  // Mobile Menu: Close menu when a link is clicked
  ...
  async function submitForm() {
      ...
      try {
          const url = `https://api.getkrowd.com/v3/sendEmail/index.cfm?companyId=1108&apiKey=krwd_6266ab2a25fffaa3fa706090773182f7b1bcb5c261e54c7c87fa60eaf99&to=Desirraaax15@aol.com&contactName=${encodeURIComponent(contactName)}&contactPhone=${encodeURIComponent(phone)}&contactEmail=${encodeURIComponent(email)}&message=${encodeURIComponent(fullMessage)}`;
          
          // Use fetch to trigger the email
          await fetch(url, { method: 'GET', mode: 'no-cors' });
